...
import com.iqmsoft.common.WelcomeMessage;
...
public class WelcomeRestService {
     ...
     * <p/>
     * By default the URL will point to 'http://localhost:8080/javafxrest-server' which should hit your
     ...
     *                  'http://localhost:8080/javafxrest-server'
     */
